...
f-name: MiFans_unlock_20190608.zip
f-size: 46.7MB
...
| Download | [via {{ page.f-host }}](https://mi.knoacc.org/dl/{{ page.f-host }}?file={{ page.f-code }}&amp;name={{ page.f-name }}&amp;size={{ page.f-size }}){:.btn.btn--primary} |
